...
{
   private int gamesToRun = 1000; //change this for amount of games to run. 1000 games takes about 5 seconds on my computer.
   ...
   public void simGames()
   {
       ...
       System.out.println("Score: " + Arrays.toString(scoreBoard));
   }
